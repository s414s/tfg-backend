...
public sealed record MarkThreadAsReadRequest(long ThreadId) : IRequest<Unit> { }

internal sealed class MarkThreadAsReadCommandHandler : IRequestHandler<MarkThreadAsReadRequest, Unit>
{
    ...
    public async Task<Unit> Handle(MarkThreadAsReadRequest request, CancellationToken cancellationToken)
    {
